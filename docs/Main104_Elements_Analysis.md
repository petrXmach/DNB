...
- **Known IDs** (from `Commands.h`):
  ...
  ID_104_Active      = 1   → 0xC0000001  // active regulation on/off
                                         //   NOTE (2026-07-29): commented out of DNBridge's
                                         //   XChng.cfg/Main104Catalog.cs — DNCoRS already
                                         //   forces Active=true always, calc always runs
                                         //   (see docs/Main104_calc_usage.md). DNC/DNCors
                                         //   unchanged; code kept commented for future use.
  ...
  ID_104_Active_ACK  = 101 → 0xC0000065  // status acknowledgment
                                         //   NOTE (2026-07-29): commented out alongside
                                         //   ID_104_Active — see note above.
